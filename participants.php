 ...
 <div class="p-card">
    <div class="v-center">
       ...
       <div class="p-card-info">
           <a href="http://hng.fun/profile/enoch_mbaebie/index.html">                     
               <!--Profile Link-->
               <h3 class="p-card-title">Enoch Mbaebie</h3>
               <!--Profile Name-->
           </a>
           <p class="p-card-description">chukwuemekambaebie@gmail.com</p>
           <!--Email-->
       </div>
       <div class="p-team">
           <a href="#">
               <h3 class="p-card-title"> Yet to get a team </h3></a></div></div></div></div>
...
<!--  Each Participant starts here  -->
               <div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(https://image.ibb.co/e0giMk/prolifichands.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                       <div class="p-card-info">
                           <a href="http://hng.fun/profile/ucinho.html">
                               <!--Profile Link-->
                               <h3 class="p-card-title">NDUBISI CHRISTIAN</h3>
                               <!--Profile Name-->
                           </a>
                           <p class="p-card-description">ucinho9@gmail.com</p>
                           <!--Email-->
                       </div>
                       <div class="p-team">
                           <a href="#">
                               <h3 class="p-card-title"> Team-Limitless </h3>
                               <!--Team-->
                           </a>
                       </div>
                   </div>
               ...
               <div class="p-card">
                   <div class="v-center">
                       ...
                       <div class="p-card-info">
                           ...
                           <p class="p-card-description">elishaekanem@yahoo.com</p></div></div></div>
<!--  Each Participants ends here  -->
...
<div class="p-card">
            <div class="v-center">
                ...
                <div class="p-card-info">
                    ...
                    <a href="http://hng.fun/profile/OgunmodedeOladunni/lizdunnes.html">
                        <!--Profile Link-->
                        <h3 class="p-card-title">Ogunmodede Oladunni</h3>
                        <!--Profile Name-->
                    </a>
                    <p class="p-card-description">elizdunnes@gmail.com</p>
                    <!--Email-->
                </div>
...
<div class="p-card">
    <div class="v-center">
        <div class="p-card-photo" style="background-image: url(https://instagram.flos2-1.fna.fbcdn.net/t51.2885-15/e35/18812667_1846669062260926_8245218755886448640_n.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
        <div class="p-card-info">
            <a href="http://hng.fun/profile/idongesitsunday.html">
                <!--Profile Link-->
                <h3 class="p-card-title">Idongesit Albert</h3>
                <!--Profile Name-->
            </a>
            <p class="p-card-description">sundayidongesit@gmail.com</p>
            <!--Email-->
        </div>
        <div class="p-team">
            <a href="#">
...
<div class="p-card">
    <div class="v-center">
        <div class="p-card-photo" style=" background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
        <div class="p-card-info">
            <a href="http://hng.fun/profile/andikan/index.html">
                <!--Profile Link-->
                <h3 class="p-card-title">Andikan Affiah</h3>
                <!--Profile Name-->
            </a>
            <p class="p-card-description">kyrioxlamda@gmail.com</p>
            <!--Email-->
        </div>
        <div class="p-team">
            <a href="#">
...
<div class="p-card">
    <div class="v-center">
        ...
        <div class="p-card-info">
            ...
            <p class="p-card-description">isaacnsikak@gmail.com</p>
            <!--Email-->
        </div>
        <div class="p-team">
            <a href="#">
...
<div class="p-card">
    <div class="v-center">
        ...
        <div class="p-card-info">
            ...
            <p class="p-card-description">mfonabasiisaac@gmail.com</p>
            <!--Email-->
        </div>
        <div class="p-team">
            <a href="#">
...
<!--  Each Participants ends here  -->
        ...
        <div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(https://image.ibb.co/e0giMk/prolifichands.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                       <div class="p-card-info">
                           <a href="http://hng.fun/profile/Adnan%20Adetunji/profile.html">
                               <!--Profile Link-->
...
<!--  Each Participant starts here  -->
       ...
       <!--  Each Participant starts here  -->
               <div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(http://www.planwallpaper.com/static/images/blurry-lights-background.jpg")></div>
                       <div class="p-card-info">
                ...
                <div class="v-center">
                    ...
                    <div class="p-card-info">
                        <a href="http://http://hng.fun/profile/oghenebrume.html">
                            <!--Profile Link-->
                            <h3 class="p-card-title">Noriode Raphael Brume</h3>
                            <!--Profile Name-->
                        </a>
...
<!--  Each Participant starts here  -->
               <div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(https://image.ibb.co/e0giMk/prolifichands.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                       <div class="p-card-info">
                           <a href="http://hng.fun/profile/dot.e.html">
                               <!--Profile Link-->
...
<div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(https://scontent.flos2-1.fna.fbcdn.net/v/t1.0-9/18058073_830806640405023_7265722691586714055_n.jpg?_nc_eui2=v1%3AAeFAuVy-anoKcMQ7xp51gy3v6uVVhs_080v279ZZ0MfDpkdjKSoyiTzq0Knd_xZa8ncXSm5mFgwSUZSvOVoK2Hv0cyPob28gblzFUOOWMgEahA&oh=d3b42cc6a6f1e5bd29bba771fe491709&oe=5A4A99F4); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                       <div class="p-card-info">
                           <a href="http://hng.fun/profile/winsome.html">
                               <!--Profile Link-->
                               <h3 class="p-card-title">NSEGOD N. N.</h3>
                               <!--Profile Name-->
                           </a>
...
<div class="p-card">
                   <div class="v-center">
                       <div class="p-card-photo" style="background-image: url(https://imgur.com/JrxaFXZ.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center; "></div>
                       <div class="p-card-info">
                           <a href="http://hng.fun/profile/ESMERALDOES.html">
                               <!--Profile Link-->
                               <h3 class="p-card-title">victor umoh</h3>
                               <!--Profile Name-->
                           </a>
                           <p class="p-card-description">umoh.esmeraldoes@gmail.com</p>
                           <!--Email-->
                       </div>
                       <div class="p-team">
                           <a href="#">
